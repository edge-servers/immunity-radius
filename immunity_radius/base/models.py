...
from immunity_utils.base import KeyField, TimeStampedEditableModel, UUIDModel
...
class AbstractRadiusGroup(OrgMixin, TimeStampedEditableModel):
    ...
    def get_default_queryset(self):
        ...
        overridable by immunity-radius and other 3rd party apps
        """
...
class AbstractRegisteredUser(models.Model):
    ...
    def unverify_inactive_users(cls):
        ...
        # to re-verify. See https://github.com/edge-servers/immunity-radius/issues/517
