...
from immunity_utils.admin_theme.email import send_email
...
class ModeSwitcherForm(forms.ModelForm):
    ...
    class Media:
        js = ['admin/js/jquery.init.js', 'immunity-radius/js/mode-switcher.js']
        css = {'all': ('immunity-radius/css/mode-switcher.css',)}
