...
from immunity_users.admin import OrganizationAdmin, UserAdmin
...
class RadiusBatchAdmin(MultitenantAdminMixin, TimeStampedEditableAdmin):
    change_form_template = 'immunity-radius/admin/rad_batch_users_change_form.html'
    add_form_template = 'immunity-radius/admin/rad_batch_users_add_form.html'
    list_display = [
        'name',
        'organization',
        'strategy',
    ...
    help_text = {
        ...
        'documentation_url': (
            'https://immunity-radius.readthedocs.io/en/latest/user/importing_users.html'
        ),
    }
    ...
    class Media:
        js = [
            ...
            'immunity-radius/js/strategy-switcher.js',
        ]
        css = {
            'all': (
                'immunity-radius/css/radiusbatch.css',
...
class OrganizationRadiusSettingsInline(admin.StackedInline):
    ...
    class Media:
        js = [
            'admin/js/jquery.init.js',
            'immunity-radius/js/organization-setting-inline.js',
        ]
